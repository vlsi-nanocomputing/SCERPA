...
<qcalayout>
    ...
    <layout>
        ...
        <item comp="0" id="2" x="8" y="0" layer="0">
            <property name="phase" value="1"/>
        </item>
        <item comp="0" id="3" x="4" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="4" x="9" y="0" layer="0">
            <property name="phase" value="2"/>
        </item>
        <item comp="0" id="5" x="10" y="0" layer="0">
            <property name="phase" value="2"/>
        </item>
        <item comp="0" id="6" x="3" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="7" x="7" y="0" layer="0">
            <property name="phase" value="1"/>
        </item>
        <item comp="0" id="8" x="2" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="9" x="1" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="10" x="5" y="0" layer="0">
            <property name="phase" value="1"/>
        </item>
        <item comp="0" id="11" x="6" y="0" layer="0">
            <property name="phase" value="1"/>
        </item>
        ...
        <pin tech="MolQCA" name="y" direction="1" id="14" x="13" y="0" layer="0"/>
    </layout>
</qcalayout>
