...
<qcalayout>
    ...
    <layout>
        ...
        <item comp="0" id="3" x="7" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="4" x="6" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <pin tech="MolQCA" name="y" direction="0" id="5" x="9" y="0" layer="0"/>
        <pin tech="MolQCA" name="a" direction="0" id="6" x="0" y="0" layer="0"/>
        <item comp="0" id="7" x="2" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="8" x="1" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
