    ...
    for i=1:row
        for l=1:column
            if (strncmp(QCA_circuit.structure(i,l),'Dr',2))
                [driver_stack] = GenerateDriverStack(QCA_circuit.dist_z, QCA_circuit.dist_y, i, l, driver_stack, dot_position, QCA_circuit.structure(i,l), QCA_circuit.rotation{i,l});
